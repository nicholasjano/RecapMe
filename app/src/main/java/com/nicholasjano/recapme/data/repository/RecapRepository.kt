package com.nicholasjano.recapme.data.repository

import com.nicholasjano.recapme.data.api.RecapApiService
import com.nicholasjano.recapme.data.api.RecapRequest
...
class RecapRepository {
    ...
    init {
        ...
        val apiKeyInterceptor = Interceptor { chain ->
            ...
            if (com.nicholasjano.recapme.BuildConfig.RECAP_API_KEY.isNotEmpty()) {
                requestBuilder.addHeader("X-API-Key", com.nicholasjano.recapme.BuildConfig.RECAP_API_KEY)
            }
        ...
        val retrofit = Retrofit.Builder()
            .baseUrl(com.nicholasjano.recapme.BuildConfig.RECAP_API_URL)
            .client(okHttpClient)
